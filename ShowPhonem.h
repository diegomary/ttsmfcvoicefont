...
class ShowPhonem : public CDialog
{
	DECLARE_DYNAMIC(ShowPhonem)

public:
	ShowPhonem(CWnd* pParent = NULL);   // standard constructor
	virtual ~ShowPhonem();
CSize m_szSize;
// Dialog Data
	
enum { IDD = IDD_SHOWPHONEM };
protected:
...
public:
	afx_msg void OnBnClickedPlayphonem();
};
